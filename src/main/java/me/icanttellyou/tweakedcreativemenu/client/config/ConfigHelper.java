                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        ...
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(getConfigText("displayIdAdvanced.name"))
                                        .description(OptionDescription.of(getConfigText("displayIdAdvanced.desc")))
                                        .binding(true, () -> config.displayIdAdvanced, newVal -> config.displayIdAdvanced = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
